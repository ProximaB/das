...
import (
	...
	"github.com/ProximaB/das/config/routes/account"
	"github.com/ProximaB/das/config/routes/admin"
	"github.com/ProximaB/das/config/routes/competition"
	"github.com/ProximaB/das/config/routes/middleware"
	"github.com/ProximaB/das/config/routes/organizer"
	"github.com/ProximaB/das/config/routes/partnership"
	"github.com/ProximaB/das/config/routes/reference"
	"github.com/ProximaB/das/config/routes/registration"
...
func NewDasRouter() *mux.Router {
	...
	addDasControllerGroup(router, organizer.OrganizerCompetitionEventTemplateControllerGroup)
	addDasControllerGroup(router, organizer.OrganizerLeadTagManagementControllerGroup)
