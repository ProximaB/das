...
func TestPostgresSchoolRepository_SearchSchool(t *testing.T) {
	...
	schools, _ := schoolRepository.SearchSchool(referencebll.SearchSchoolCriteria{})
...
func TestPostgresSchoolRepository_CreateSchool(t *testing.T) {
	...
	mock.ExpectCommit()
	args := referencebll.School{Name: "Intergalactic College", CityID: 44}
...
func TestPostgresSchoolRepository_DeleteSchool(t *testing.T) {
	...
	args := referencebll.School{ID: 66, Name: "Intergalactic College", CityID: 44}
	mock.ExpectBegin()
